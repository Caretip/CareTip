 ...
 * Checkpoint 6 — pages register while isDirty / unregister on clean / unmount.
 */
...
export function getIdleDirtyCount(): number {
  return reasons.size;
}
...
/** Test-only reset. */
export function resetIdleDirtyRegistryForTests(): void {
  reasons.clear();
  listeners.clear();
}
