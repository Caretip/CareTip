 ...
 * One authored template; address is a dynamic node, not a second flattened file.
 */
export const CARETIP_A5_FLYER_TEMPLATE: PhysicalQrProductTemplate = {
  id: PHYSICAL_QR_TEMPLATE_ID,
  nameKey: "business.qrStudio.physical.templateName",
  descriptionKey: "business.qrStudio.physical.templateDesc",
...
const BY_ID = new Map<string, PhysicalQrProductTemplate>([
  [CARETIP_A5_FLYER_TEMPLATE.id, CARETIP_A5_FLYER_TEMPLATE],
]);
...
export function listPhysicalQrTemplates(): readonly PhysicalQrProductTemplate[] {
  return [CARETIP_A5_FLYER_TEMPLATE];
}
