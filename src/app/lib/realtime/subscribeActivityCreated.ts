...
import { REALTIME_EVENTS, type RealtimeEventEnvelope } from "./realtimeContracts";
...
/** Subscribe to Activity Center live events only (`activity.created`). Do not use tip sockets here. */
