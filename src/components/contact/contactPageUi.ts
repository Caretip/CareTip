...
export const contactPageUi = {
  ...
  input:
    "caretip-contact-input w-full rounded-xl border border-border/80 bg-input-background px-4 py-3 font-sans text-sm text-foreground placeholder:text-muted-foreground transition-[box-shadow,border-color,background-color] focus:outline-none focus:ring-2 focus:ring-primary/30",
  textarea:
    "caretip-contact-input caretip-contact-textarea w-full resize-none rounded-xl border border-border/80 bg-input-background px-4 py-3 font-sans text-sm text-foreground placeholder:text-muted-foreground transition-[box-shadow,border-color,background-color] focus:outline-none focus:ring-2 focus:ring-primary/30",
