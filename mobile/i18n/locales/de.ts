...
export const de: MobileMessages = {
  ...
  auth: {
    ...
    signInLink: "Anmelden",
    googleSignInFailed: "Anmeldung mit Google nicht möglich. Bitte erneut versuchen.",
    ...
    appleSignInFailed: "Anmeldung mit Apple nicht möglich. Bitte erneut versuchen.",
    ...
    facebookSignInFailed: "Anmeldung mit Facebook nicht möglich. Bitte erneut versuchen.",
    facebookSignInCancelled: "Facebook-Anmeldung abgebrochen.",
    facebookNotConfigured: "Facebook-Anmeldung ist in dieser App-Version nicht verfügbar.",
