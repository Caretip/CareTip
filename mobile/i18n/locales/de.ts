...
export const de: MobileMessages = {
  ...
  auth: {
    ...
    orContinueWith: "oder",
    createAccountTitle: "CareTip-Konto erstellen",
    createAccountSubtitle: "Wählen Sie, wie Sie fortfahren möchten.",
    ...
    googleAccountNotRegistered: "Kein CareTip-Konto für diese Google-E-Mail gefunden. Erstellen Sie ein Konto, um fortzufahren.",
    googleTokenInvalid: "Google konnte Ihre Identität nicht bestätigen. Bitte erneut versuchen.",
    registerScreenTitle: "Konto erstellen",
    registerScreenSubtitle: "Registrieren Sie sich mit E-Mail und Passwort.",
    ...
    resetPasswordSubtitle: "Wählen Sie ein sicheres Passwort für CareTip.",
    ...
    verifyEmailSubtitle: "Wir haben einen Link an {{email}} gesendet.",
