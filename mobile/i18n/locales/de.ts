...
export const de: MobileMessages = {
  ...
  employeePayouts: {
    title: "Auszahlungen",
    subtitle: "Stripe-Sofortauszahlung und Bankauszahlungen",
    ...
    instantLead: "Zahlt verfügbares Stripe-Guthaben aus. Betrag, Zielkonto und Gebühr setzt der Server.",
    instantCta: "Guthaben jetzt erhalten",
    instantChecking: "Sofortauszahlung wird geprüft…",
    instantUnavailable: "Sofortauszahlung ist gerade nicht verfügbar.",
    instantSuccess: "Sofortauszahlung gesendet.",
    instantFailed: "Sofortauszahlung konnte nicht abgeschlossen werden.",
    instantMin: "Mindestbetrag 30,00 €",
    instantFee: "Die Gebühr kommt von Stripe (Ziel 2,5 % gesamt). CareTip rechnet keine zweite Gebühr.",
    historyTitle: "Stripe-Bankauszahlungen",
    historyEmpty: "Noch keine Stripe-Bankauszahlungen.",
    historyHint: "Das sind Stripe-Auszahlungen auf Ihr Bankkonto, keine CareTip-Überweisungen.",
    dashboardCta: "Stripe-Dashboard öffnen",
    updateDetailsCta: "Stripe-Daten aktualisieren",
    noSteerHint: "CareTip legt Betrag und Ziel fest. Die App kann das nicht überschreiben.",
  },
  employeeAssignment: {
    eyebrow: "ZUWEISUNG",
