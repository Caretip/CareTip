...
export type MobileMessages = {
  ...
  auth: {
    ...
    onboardingSessionExpired: string;
    onboardingBusinessUnavailable: string;
  };
  info: {
    faqTitle: string;
    faqSearch: string;
  ...
  employeePayouts: {
    ...
    reasonNoDestination: string;
    reasonPayoutsDisabled: string;
    reasonCountry: string;
    reasonBusinessClosed: string;
    ...
    historyEmptyBankBody: string;
    historyEmptyCaretip: string;
    historyEmptyCaretipBody: string;
    ...
    activityTransferred: string;
    activityRouted: string;
    activityHeld: string;
    activityHeldVenue: string;
    activityTransferring: string;
